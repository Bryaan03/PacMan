...
import fr.univartois.butinfo.r304.pacman.model.animated.SpeedState;
 ...
 * @version 0.1.0
 */
public class BonusSpeed extends AbstractAnimated implements IBonus {
    /**
     ...
     */
    public BonusSpeed(PacmanGame game, double xPosition, double yPosition, Sprite sprite) {
     ...
     */
    @Override
    public void applyBonus(PacMan pacMan) { pacMan.changeState(new SpeedState(pacMan)); }
