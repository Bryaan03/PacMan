...
public interface IAnimated {
	 ...
	 *
	 * @param speed La nouvelle vitesse horizontale de cet objet animé (en
	 *              pixels/s).
	 */
	...
	/**
	 * Donne la propriété de cet objet correspondant au {@link Sprite} qui le
	 * représente.
	 *
	...
	/**
	 * Donne la propriété de cet objet correspondant à l'{@link Image} qui le
	 * représente.
	 *
	...
	/**
	 * Modifie l'état de destruction de cet objet animé. Lorsqu'un élément du jeu
	 * est détruit, il est retiré du jeu mais sa représentation graphique peut
	 * persister un court instant le temps que la destruction soit prise en compte.
	 * Cette méthode contribue à éviter de prendre en compte ces objets "zombies"
	...
	/**
	 * Donne l'état de destruction de cet objet animé. Lorsqu'un élément du jeu est
	 * détruit, il est retiré du jeu mais sa représentation graphique peut persister
	 * un court instant le temps que la destruction soit prise en compte. Cette
	 * méthode contribue à éviter de prendre en compte ces objets "zombies" dans la
	 * logique du jeu.
	 *
	...
	/**
	 * Donne la propriété liée à l'état de destruction de cet objet animé. Lorsqu'un
	 * élément du jeu est détruit, il est retiré du jeu mais sa représentation
	 * graphique peut persister un court instant le temps que la destruction soit
	 * prise en compte. Cette méthode contribue à éviter de prendre en compte ces
	 * objets "zombies" dans la logique du jeu.
	 *
	...
	/**
	 * Réalise des initialisations particulières lors de la création de cet objet
	 * animé.
	 */
	void onCreation();

	/**
	 * Réalise des initialisations particulières lors de l'apparition sur la carte
	 * de cet objet animé.
	 */
	void onSpawn();
	 ...
	 *
	 * @param timeDelta Le temps écoulé depuis la dernière mise à jour de cet objet
	 *                  (en millisecondes).
	 *
	...
	/**
	 * Réinitialise ou libère certaines ressources lorsque cet objet animé est
	 * retiré de l'affichage, sans toutefois être retiré du jeu.
	 */
	void onDespawn();
	 ...
	 *
	 * @param other l'objet fantôme.
	 */
	void onCollisionWith(Ghost other);

	/**
	 * Gère la collision avec un point(Pac-Gomme).
	 *
	 * @param other l'objet PacGomme.
	 */
	void onCollisionWith(PacGomme other);

	/**
	 * Gère la collision avec un bonus(Mega-Gum).
	 *
	 * @param other l'objet bonus.
	 */
	void onCollisionWith(IBonus other);

	/**
	 * Gère la collision avec un mur.
	 *
	 * @param other l'objet mur.
	 */
	void onCollisionWith(Wall other);
}